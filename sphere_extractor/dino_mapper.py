...
class DINOMapper(nn.Module):    
    def __init__(self, backbone='dinov2_vitb14', n_cats=1):
        ...
        if 'dinov2' in backbone:
            # Pinned to a python-3.8-compatible commit; newer dinov2 revisions
            # use `X | None` annotations that need python >= 3.10.
            repo = 'facebookresearch/dinov2:e1277af2ba9496fbadf7aec6eba56e8d882d1e35'
        else:
            repo = 'facebookresearch/dino'


        self.dino = torch.hub.load(repo, backbone, skip_validation=True)
